##python run.py --bert_model_dir data/bert/bert-base-uncased-pytorch_model --glove_dir glove --gat_bert --embedding_type bert --output_dir data/output-gcn --dropout 0.3 --hidden_size 200 --learning_rate 5e-5 #R-GAT+BERT in restaurant
...
#python run.py --gat_our --highway --num_heads 7 --dropout 0.8
